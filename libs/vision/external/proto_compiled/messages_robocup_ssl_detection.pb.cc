...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_messages_5frobocup_5fssl_5fdetection_2eproto = {
  false, false, descriptor_table_protodef_messages_5frobocup_5fssl_5fdetection_2eproto, "messages_robocup_ssl_detection.proto", 560,
...
::PROTOBUF_NAMESPACE_ID::uint8* SSL_DetectionFrame::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(8, this->_internal_t_capture_camera(), target);
  }
